...
<body class="font-sans bg-gray-50 text-gray-800 antialiased flex h-screen overflow-hidden">
  ...
  <aside class="w-64 bg-brand-dark text-white flex flex-col shrink-0 hidden md:flex">
    ...
    <nav class="flex-1 p-4 space-y-1">
      ...
      <a href="{{ url('/admin/customers') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold {{ Request::is('admin/customers*') ? 'bg-white/10 text-white' : 'text-blue-100/70 hover:bg-white/5 hover:text-white' }} transition-all">
